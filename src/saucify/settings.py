"""
Django settings for saucify project.
...
SECRET_KEY = 'django-insecure-j2i2%cz#e%ct-i!=e*a%eul!n=o#6#o-r&g8n&(tpz($cv3auv'
...
WSGI_APPLICATION = 'saucify.wsgi.application'
